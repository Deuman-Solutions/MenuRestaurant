...
export function MenuItemCard({ item, onSelect }: MenuItemCardProps) {
  return (
    <button
      ...
      className="flex w-full text-left border border-border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow bg-card focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
    >
